...
using RayToDo.Api.Providers;
using RayToDo.Api.RequestModels.Account;
using RayToDo.Api.ResponseModels.Account;
using RayToDo.Api.Results;
...
namespace RayToDo.Api.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        [Route("manage-info")]
        public async Task<ManageInfoResponseModel> GetManageInfo(string returnUrl, bool generateState = false)
        {
            ...
            List<UserLoginInfoResponseModel> logins = new List<UserLoginInfoResponseModel>();

            foreach (UserLogin linkedAccount in user.Logins)
            {
                logins.Add(new UserLoginInfoResponseModel
                {
                    LoginProvider = linkedAccount.Provider,
            ...
            return new ManageInfoResponseModel
            {
        ...
        [Route("set-password")]
        public async Task<IHttpActionResult> SetPassword(SetPasswordRequestModel model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        public async Task<IHttpActionResult> AddExternalLogin(AddExternalLoginRequestModel model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        public IEnumerable<ExternalLoginResponseModel> GetExternalLogins(string returnUrl, bool generateState = false)
        {
            IEnumerable<AuthenticationDescription> descriptions = Authentication.GetExternalAuthenticationTypes();
            List<ExternalLoginResponseModel> logins = new List<ExternalLoginResponseModel>();
            ...
            {
                ExternalLoginResponseModel login = new ExternalLoginResponseModel
                {
        ...
        public async Task<IHttpActionResult> RegisterExternal(RegisterExternalRequestModel model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
